 ...
 */
(function(m){var w='{preview}\n<div class="input-group {class}">\n   {caption}\n   <div class="input-group-btn">\n       {remove}\n       {upload}\n       {browse}\n   </div>\n</div>';var g="{preview}\n{remove}\n{upload}\n{browse}\n";var b='<div class="file-preview {class}">\n   <div class="file-preview-status text-center text-success"></div>\n   <div class="close fileinput-remove text-right">&times;</div>\n   <div class="file-preview-thumbnails"></div>\n   <div class="clearfix"></div></div>';var j='<div class="form-control file-caption {class}">\n   <span class="glyphicon glyphicon-file"></span> <span class="file-caption-name"></span>\n</div>';var x='<div id="{id}" class="modal fade">\n  <div class="modal-dialog modal-lg">\n    <div class="modal-content">\n      <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h3 class="modal-title">Detailed Preview <small>{title}</small></h3>\n      </div>\n      <div class="modal-body">\n        <textarea class="form-control" style="font-family:Monaco,Consolas,monospace; height: {height}px;" readonly>{body}</textarea>\n      </div>\n    </div>\n  </div>\n</div>\n';var d=function(a,c){return a===null||a===undefined||a==[]||a===""||c&&m.trim(a)===""};var v=function(c,a,f){return d(c)||d(c[a])?f:c[a]};var q=function(c,a){return typeof c!=="undefined"?c.match("image.*"):a.match(/\.(gif|png|jpe?g)$/i)};var k=function(c,a){return typeof c!=="undefined"?c.match("text.*"):a.match(/\.(txt|md|csv|htm|html|php|ini)$/i)};var h=function(){return Math.round((new Date).getTime()+Math.random()*100)};var p=function(c,a){this.$element=m(c);this.showCaption=a.showCaption;this.showPreview=a.showPreview;this.showRemove=a.showRemove;this.showUpload=a.showUpload;this.captionClass=a.captionClass;this.previewClass=a.previewClass;this.mainClass=a.mainClass;if(d(a.mainTemplate)){this.mainTemplate=this.showCaption?w:g}else{this.mainTemplate=a.mainTemplate}this.previewTemplate=this.showPreview?a.previewTemplate:"";this.captionTemplate=a.captionTemplate;this.browseLabel=a.browseLabel;this.browseIcon=a.browseIcon;this.browseClass=a.browseClass;this.removeLabel=a.removeLabel;this.removeIcon=a.removeIcon;this.removeClass=a.removeClass;this.uploadLabel=a.uploadLabel;this.uploadIcon=a.uploadIcon;this.uploadClass=a.uploadClass;this.uploadUrl=a.uploadUrl;this.msgLoading=a.msgLoading;this.msgProgress=a.msgProgress;this.msgSelected=a.msgSelected;this.previewFileType=a.previewFileType;this.wrapTextLength=a.wrapTextLength;this.wrapIndicator=a.wrapIndicator;this.isDisabled=this.$element.attr("disabled")||this.$element.attr("readonly");if(d(this.$element.attr("id"))){this.$element.attr("id",h())}this.$container=this.createContainer();this.$captionContainer=v(a,"elCaptionContainer",this.$container.find(".file-caption"));this.$caption=v(a,"elCaptionText",this.$container.find(".file-caption-name"));this.$previewContainer=v(a,"elPreviewContainer",this.$container.find(".file-preview"));this.$preview=v(a,"elPreviewImage",this.$container.find(".file-preview-thumbnails"));this.$previewStatus=v(a,"elPreviewStatus",this.$container.find(".file-preview-status"));this.$name=this.$element.attr("name")||a.name;this.$hidden=this.$container.find('input[type=hidden][name="'+this.$name+'"]');if(this.$hidden.length===0){this.$hidden=m('<input type="hidden" />');this.$container.prepend(this.$hidden)}this.original={preview:this.$preview.html(),hiddenVal:this.$hidden.val()};this.listen()};p.prototype={constructor:p,listen:function(){var a=this;a.$element.on("change",m.proxy(a.change,a));m(a.$element[0].form).on("reset",m.proxy(a.reset,a));a.$container.find(".fileinput-remove").on("click",m.proxy(a.clear,a))},trigger:function(c){var a=this;a.$element.trigger("click");c.preventDefault()},clear:function(c){var a=this;
if(c){c.preventDefault()}a.$hidden.val("");a.$hidden.attr("name",a.name);a.$element.attr("name","");a.$element.val("");if(c!==false){a.$element.trigger("change");a.$element.trigger("fileclear")}a.$preview.html("");a.$caption.html("");a.$container.removeClass("file-input-new").addClass("file-input-new")},reset:function(c){var a=this;a.clear(false);a.$hidden.val(a.original.hiddenVal);a.$preview.html(a.original.preview);a.$container.find(".fileinput-filename").text("");a.$element.trigger("filereset")},change:function(L){var B=this;var G=B.$element,C=G.get(0).files,I=C?C.length:1,F=G.val().replace(/\\/g,"/").replace(/.*\//,""),z=B.$preview,N=B.$previewContainer,J=B.$previewStatus,D=B.msgLoading,M=B.msgProgress,s=B.msgSelected,H,K=B.previewFileType,f=parseInt(B.wrapTextLength),O=B.wrapIndicator;if(L.target.files===undefined){H=L.target&&L.target.value?[{name:L.target.value.replace(/^.+\\/,"")}]:[]}else{H=L.target.files}if(H.length===0){return}z.html("");var l=H.length,B=B;for(var A=0;A<l;A++){(function(y){var o=y.name;var E=q(y.type,y.name);var u=k(y.type,y.name);if(z.length>0&&(K=="any"?E||u:K=="text"?u:E)&&typeof FileReader!=="undefined"){var c=new FileReader;J.html(D);N.addClass("loading");c.onload=function(Q){var S="",t="";if(u){var R=Q.target.result;if(R.length>f){var r=h(),P=window.innerHeight*0.75,t=x.replace("{id}",r).replace("{title}",o).replace("{body}",R).replace("{height}",P);O=O.replace("{title}",o).replace("{dialog}","$('#"+r+"').modal('show')");R=R.substring(0,f-1)+O}S='<div class="file-preview-frame"><div class="file-preview-text" title="'+o+'">'+R+"</div></div>"+t}else{S='<div class="file-preview-frame"><img src="'+Q.target.result+'" class="file-preview-image" title="'+o+'" alt="'+o+'"></div>'}z.append("\n"+S);if(A>=l-1){N.removeClass("loading");J.html("")}};c.onprogress=function(e){if(e.lengthComputable){var P=parseInt(e.loaded/e.total*100,10);var i=M.replace("{percent}",P).replace("{file}",y.name);J.html(i)}};if(u){c.readAsText(y)}else{c.readAsDataURL(y)}}else{z.append('\n<div class="file-preview-frame"><div class="file-preview-other"><h2><i class="glyphicon glyphicon-file"></i></h2>'+o+"</div></div>")}})(H[A])}var a=I>1?s.replace("{n}",I):F;B.$caption.html(a);B.$container.removeClass("file-input-new");G.trigger("fileselect",[I,F])},createContainer:function(){var a=this;var c=m(document.createElement("div")).attr({"class":"file-input file-input-new"}).html(a.renderMain());a.$element.before(c);c.find(".btn-file").append(a.$element);return c},renderMain:function(){var f=this;var a=f.previewTemplate.replace("{class}",f.previewClass);var i=f.isDisabled?f.captionClass+" file-caption-disabled":f.captionClass;var c=f.captionTemplate.replace("{class}",i);return f.mainTemplate.replace("{class}",f.mainClass).replace("{preview}",a).replace("{caption}",c).replace("{upload}",f.renderUpload()).replace("{remove}",f.renderRemove()).replace("{browse}",f.renderBrowse())},renderBrowse:function(){var c=this,a=c.browseClass+" btn-file",f="";if(c.isDisabled){f=" disabled "}return'<div class="'+a+'"'+f+"> "+c.browseIcon+c.browseLabel+" </div>"},renderRemove:function(){var c=this,a=c.removeClass+" fileinput-remove fileinput-remove-button",f="";if(!c.showRemove){return""}if(c.isDisabled){f=" disabled "}return'<button type="button" class="'+a+'"'+f+">"+c.removeIcon+c.removeLabel+"</button>"},renderUpload:function(){var c=this,a="",f="";if(!c.showUpload){return""}if(c.isDisabled){f=" disabled "}if(d(c.uploadUrl)){a='<button type="submit" class="'+c.uploadClass+'"'+f+">"+c.uploadIcon+c.uploadLabel+"</button>"}else{a='<a href="'+c.uploadUrl+'" class="'+c.uploadClass+'"'+f+">"+c.uploadIcon+c.uploadLabel+"</a>"}return a}};m.fn.fileinput=function(a){return this.each(function(){var e=m(this),c=e.data("fileinput");if(!c){e.data("fileinput",c=new p(this,a))}if(typeof a=="string"){c[a]()}})};m.fn.fileinput=function(a){var c=Array.apply(null,arguments);c.shift();return this.each(function(){var l=m(this),e=l.data("fileinput"),f=typeof a==="object"&&a;
if(!e){l.data("fileinput",e=new p(this,m.extend({},m.fn.fileinput.defaults,f,m(this).data())))}if(typeof a==="string"){e[a].apply(e,c)}})};m.fn.fileinput.defaults={showCaption:true,showPreview:true,showRemove:true,showUpload:true,captionClass:"",previewClass:"",mainClass:"",mainTemplate:null,previewTemplate:b,captionTemplate:j,browseLabel:"Browse &hellip;",browseIcon:'<i class="glyphicon glyphicon-folder-open"></i> &nbsp;',browseClass:"btn btn-primary",removeLabel:"Remove",removeIcon:'<i class="glyphicon glyphicon-ban-circle"></i> ',removeClass:"btn btn-default",uploadLabel:"Upload",uploadIcon:'<i class="glyphicon glyphicon-upload"></i> ',uploadClass:"btn btn-default",uploadUrl:null,msgLoading:"Loading &hellip;",msgProgress:"Loaded {percent}% of {file}",msgSelected:"{n} files selected",previewFileType:"image",wrapTextLength:250,wrapIndicator:' <span class="wrap-indicator" title="{title}" onclick="{dialog}">[&hellip;]</span>',elCaptionContainer:null,elCaptionText:null,elPreviewContainer:null,elPreviewImage:null,elPreviewStatus:null};m(function(){var a=m("input.file[type=file]");if(a.length>0){a.fileinput()}})})(window.jQuery);$(document).ready(function(g){equalHeight(".equal-height");g(".nav > li > ul li > ul").css("left",g(".nav > li > ul").width());var h=g(".nav > li");h.hover(function(){if(g("body").hasClass("navigation-fixed-bottom")){if(g(window).width()>768){var q=g(window).height()-(g(this).offset().top-g(window).scrollTop());if(q<g(this).children(".child-navigation").height()){g(this).children(".child-navigation").addClass("position-bottom")}else{g(this).children(".child-navigation").removeClass("position-bottom")}}}});setNavigationPosition();g(".tool-tip").tooltip();var m=g("select");if(m.length>0){m.selectpicker()}var p=g(".bootstrap-select");var c=g(".dropdown-menu");p.on("shown.bs.dropdown",function(){c.removeClass("animation-fade-out");c.addClass("animation-fade-in")});p.on("hide.bs.dropdown",function(){c.removeClass("animation-fade-in");c.addClass("animation-fade-out")});p.on("hidden.bs.dropdown",function(){var q=g(this);g(q).addClass("open");setTimeout(function(){g(q).removeClass("open")},100)});m.change(function(){if(g(this).val()!=""){g(".form-search .bootstrap-select.open").addClass("selected-option-check")}else{g(".form-search  .bootstrap-select.open").removeClass("selected-option-check")}});g("#form-contact-submit").bind("click",function(q){g("#form-contact").validate({submitHandler:function(){g.post("http://assets.gotocy.com/static/php/contact.php",g("#form-contact").serialize(),function(r){g("#form-status").html(r);g("#form-contact-submit").attr("disabled","true")});return false}})});if(g(".video").length>0){g(".video").fitVids()}var a=g("#price-input");if(a.length>0){a.slider({from:100,to:5000000,step:100,heterogeneity:["30/5000","60/500000"],format:{format:"###,###",locale:"en"},dimension:"&nbsp;€"})}g("#map .marker-style").css("opacity",".5 !important");g("#map .marker-style").css("bakground-color","red");g(window).scroll(function(){var q=g(window).scrollTop()/1.5;q=Math.round(q);if(g("body").hasClass("navigation-fixed-bottom")){if(g(window).scrollTop()>g(window).height()-g(".navigation").height()){g(".navigation").addClass("navigation-fix-to-top")}else{g(".navigation").removeClass("navigation-fix-to-top")}}if(g(window).width()>768){if(g("#map").hasClass("has-parallax")){g("#map .gm-style").css("margin-top",q+"px");g("#map .leaflet-map-pane").css("margin-top",q+"px")}if(g("#slider").hasClass("has-parallax")){g(".homepage-slider").css("top",q+"px")}}});g('.navigation .nav a[href^="#"], a[href^="#"].roll').on("click",function(s){s.preventDefault();var r=this.hash,q=g(r);if(g(window).width()>768){g("html, body").stop().animate({scrollTop:q.offset().top-g(".navigation").height()},2000)}else{g("html, body").stop().animate({scrollTop:q.offset().top},2000)}});var j=g(".rating-overall");if(j.length>0){j.raty({path:"http://assets.gotocy.com/static/img",readOnly:true,score:function(){return g(this).attr("data-score")}})}var l=g(".rating-individual");if(l.length>0){l.raty({path:"http://assets.gotocy.com/static/img",readOnly:true,score:function(){return g(this).attr("data-score")}})}var f=g(".rating-user");if(f.length>0){g(".rating-user .inner").raty({path:"http://assets.gotocy.com/static/img",starOff:"big-star-off.png",starOn:"big-star-on.png",width:150,targetType:"number",targetFormat:"Rating: {score}",click:function(r,q){showRatingForm()}})}g("#agent-switch").on("ifClicked",function(q){agentState()});g("#create-account-user").on("ifClicked",function(q){g("#agent-switch").data("agent-state","");agentState()});var n=g(".bookmark");if(n.data("bookmark-state")=="empty"){n.removeClass("bookmark-added")}else{if(n.data("bookmark-state")=="added"){n.addClass("bookmark-added")}}n.on("click",function(){if(n.data("bookmark-state")=="empty"){n.data("bookmark-state","added");n.addClass("bookmark-added")}else{if(n.data("bookmark-state")=="added"){n.data("bookmark-state","empty");n.removeClass("bookmark-added")}}});if(g("body").hasClass("navigation-fixed-bottom")){g("#page-content").css("padding-top",g(".navigation").height())}if(g(".property").hasClass("masonry")){var b=g(".masonry-grid");
