...
## application wide
# yui.sh -o css/application.min.css fonts/font-awesome.min.css bootstrap/css/bootstrap.min.css css/bootstrap-select.min.css css/magnific-popup.css css/jquery.slider.min.css css/fileinput.min.css css/style.css
...
## app-wide static environment
# yui.sh -f -o js/static-application.min.js js/jquery-2.1.0.min.js js/jquery-migrate-1.2.1.min.js bootstrap/js/bootstrap.min.js js/smoothscroll.js js/bootstrap-select.min.js js/jquery.validate.min.js js/jquery.placeholder.js js/icheck.min.js js/retina-1.1.0.min.js js/jquery.raty.min.js js/jquery.magnific-popup.min.js js/jshashtable-2.1_src.js js/jquery.numberformatter-1.2.3.js js/tmpl.js js/jquery.dependClass-0.1.js js/draggable-0.1.js js/jquery.slider.min.js js/jquery.fitvids.js js/imagesloaded.pkgd.min.js js/masonry.pkgd.min.js js/scrollReveal.min.js js/canvas-to-blob.js js/fileinput.js js/custom.js js/utils.js js/static/utils.js js/home/index.js js/property/*.js js/asset/*.js
## maps
