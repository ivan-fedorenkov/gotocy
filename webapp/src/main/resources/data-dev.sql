...
insert into property (id, version, title, address, short_address, location, latitude, longitude, property_type, offer_type, price, covered_area, plot_size, distance_to_sea, bedrooms, representative_image_id, owner_id, creation_date)
  values (5, 0, 'LAR 801/1', 'Oroklini, Larnaca', 'Oroklini, Larnaca', 'LARNACA', '34.972661', '33.645909', 'APARTMENT', 'SALE', 338000, 105, 177, 1500, 3, 66, 1, 17000);
...
insert into property (id, version, title, address, short_address, location, latitude, longitude, property_type, offer_type, price, covered_area, plot_size, distance_to_sea, bedrooms, ready_to_move_in, representative_image_id, owner_id, creation_date)
  values (6, 0, 'LAR 802', 'Athenon street, Larnaca', 'Athenon street, Larnaca', 'LARNACA', '34.914313', '33.637733', 'APARTMENT', 'SALE', 572000, 78, 82, 50, 2, true, 70, 1, 17000);
...
insert into property (id, version, title, address, short_address, location, latitude, longitude, property_type, offer_type, price, bedrooms, covered_area, heating_system, furnishing, representative_image_id, pano_xml_id, owner_id, creation_date)
  values (9, 0, 'Demetris Residence', '18 Agiou Amvrosiou street Krasas area 7100 Aradippou Larnaca Cyprus', '18 Agiou Amvrosiou st, Larnaca', 'LARNACA', '34.904490', '33.587985', 'HOUSE', 'LONG_TERM', 1000, 4, 0, true, 'FULL', 93, 109, 1, 17000);
...
insert into property (id, version, title, address, short_address, location, latitude, longitude, property_type, offer_type, price, bedrooms, guests, covered_area, air_conditioner, distance_to_sea, representative_image_id, pano_xml_id, owner_id, creation_date)
  values (10, 0, 'Demetris Residence', '18 Agiou Amvrosiou street Krasas area 7100 Aradippou Larnaca Cyprus', '18 Agiou Amvrosiou st, Larnaca', 'LARNACA', '34.904490', '33.587985', 'HOUSE', 'SHORT_TERM', 100, 4, 8, 0, true, 4500, 93, 109, 1, 17000);
...
insert into property (id, version, title, location, latitude, longitude, address, short_address, property_type, offer_type, price, covered_area, plot_size, bedrooms, guests, distance_to_sea, air_conditioner, ready_to_move_in, heating_system, furnishing, representative_image_id, pano_xml_id, owner_id, creation_date)
  values (14, 0, 'Alex Residence #105', 'LARNACA', '34.920028', '33.631734', '4 Agiou Spyridonos street, 6015, Larnaca, Cyprus', '4 Agiou Spyridonos st, Larnaca', 'APARTMENT', 'SHORT_TERM', 90, 0, 0, 2, 4, 500, TRUE, FALSE, FALSE, NULL, 169, NULL, 1, 17000);
...
insert into property (id, version, title, location, latitude, longitude, address, short_address, property_type, offer_type, price, covered_area, plot_size, bedrooms, guests, distance_to_sea, air_conditioner, ready_to_move_in, heating_system, furnishing, representative_image_id, pano_xml_id, owner_id, creation_date)
  values (20, 0, 'Dimitraki Koumantari Residence', 'LARNACA', '34.940275', '33.590204', 'Demetri Koumandari Str. No.1, 7103, Aradippou, Larnaca', 'Demetri Koumandari Str.1, Larnaca', 'HOUSE', 'LONG_TERM', 850, 0, 0, 4, 10, 4700, TRUE, TRUE, TRUE, 'FULL', 300, 309, 1, 17000);
